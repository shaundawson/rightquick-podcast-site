//  Mock episodes for local development
        ...
        const mockEpisodes = [
            {
                ...
                images: [
                    {
                        url: 'https://via.placeholder.com/300x300?text=Right+Quick+Ep+1'
                    }
                ],
                external_urls: {
                    spotify: 'https://open.spotify.com/show/3nwEyCN9eUwP7QKneoYYiJ'
                }
            },
            {
                ...
                images: [
                    {
                        url: 'https://via.placeholder.com/300x300?text=Right+Quick+Ep+2'
                    }
                ],
                external_urls: {
                    spotify: 'https://open.spotify.com/show/3nwEyCN9eUwP7QKneoYYiJ'
            ...
            },
            {
                ...
                images: [
                    {
                        url: 'https://via.placeholder.com/300x300?text=Right+Quick+Ep+3'
                    }
                ],
                external_urls: {
                    spotify: 'https://open.spotify.com/show/3nwEyCN9eUwP7QKneoYYiJ'
